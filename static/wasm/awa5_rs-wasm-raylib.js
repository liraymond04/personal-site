...
function findWasmBinary() {
    var f = 'awa5_rs_wasm_raylib.wasm';
    if (!isDataURI(f)) {
      return locateFile(f);
    }
    return f;
...
var ASM_CONSTS = {
  553836: () => { if (document.fullscreenElement) return 1; },  
 553882: () => { return document.getElementById('canvas').width; },  
 553934: () => { return parseInt(document.getElementById('canvas').style.width); },  
 554002: () => { document.exitFullscreen(); },  
 554029: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 554102: () => { if (document.fullscreenElement) return 1; },  
 554148: () => { return document.getElementById('canvas').width; },  
 554200: () => { return screen.width; },  
 554225: () => { document.exitFullscreen(); },  
 554252: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 554385: () => { if (document.fullscreenElement) return 1; },  
 554431: () => { return document.getElementById('canvas').width; },  
 554483: () => { return parseInt(document.getElementById('canvas').style.width); },  
 554551: () => { if (document.fullscreenElement) return 1; },  
 554597: () => { return document.getElementById('canvas').width; },  
 554649: () => { return screen.width; },  
 554674: () => { if (document.fullscreenElement) return 1; },  
 554720: () => { return document.getElementById('canvas').width; },  
 554772: () => { return screen.width; },  
 554797: () => { document.exitFullscreen(); },  
 554824: () => { if (document.fullscreenElement) return 1; },  
 554870: () => { return document.getElementById('canvas').width; },  
 554922: () => { return parseInt(document.getElementById('canvas').style.width); },  
 554990: () => { document.exitFullscreen(); },  
 555017: () => { return screen.width; },  
 555042: () => { return screen.height; },  
 555068: () => { return window.screenX; },  
 555095: () => { return window.screenY; },  
 555122: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 555175: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 555246: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 555303: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 555374: () => { if (document.fullscreenElement) return 1; },  
 555420: () => { if (document.pointerLockElement) return 1; }
};
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 533800;
